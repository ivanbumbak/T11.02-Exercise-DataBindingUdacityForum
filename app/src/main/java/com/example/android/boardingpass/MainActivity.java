...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        String boardingTime = formatter.format(getString(R.string.boarding_time));
        String departureTime = formatter.format(getString(R.string.departure_time));
        String arrivalTime = formatter.format(getString(R.string.arrival_time));
